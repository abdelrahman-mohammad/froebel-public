...
import { FormError, FormGroup } from "@/components/ui/form-group";
...
export default function LoginPage() {
    ...
    const { login, loginWithOAuth, isLoading, isAuthenticated, isInitialized } = useAuth();
    ...
    // Don't show login form while checking auth or if already authenticated
    if (!isInitialized || isAuthenticated) {
        return null;
    }
