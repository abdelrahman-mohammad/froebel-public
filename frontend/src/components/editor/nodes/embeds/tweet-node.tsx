/* eslint-disable react-hooks/set-state-in-effect, react/display-name, @typescript-eslint/no-empty-object-type */
// Lexical editor node with complex state patterns
