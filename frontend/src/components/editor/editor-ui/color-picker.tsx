"use client";
"use no memo";
/* eslint-disable react-hooks/use-memo, react-hooks/exhaustive-deps, react-hooks/refs, react/display-name, @typescript-eslint/no-empty-object-type, react-hooks/set-state-in-effect */
// This component uses advanced ref composition patterns and memoization
...
function ColorPickerInput(props: ColorPickerInputProps) {
    ...
    if (format === "hex") {
        return (
            <HexInput color={color} onColorChange={onColorChange} context={context} {...props} />
        );
    }

    if (format === "rgb") {
        return (
            <RgbInput color={color} onColorChange={onColorChange} context={context} {...props} />
        );
    }

    if (format === "hsl") {
        return (
            <HslInput color={color} onColorChange={onColorChange} context={context} {...props} />
        );
    }
