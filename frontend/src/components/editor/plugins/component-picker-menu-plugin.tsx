"use client";
/* eslint-disable react-hooks/set-state-in-effect, react-hooks/exhaustive-deps, @typescript-eslint/no-empty-object-type */
// Lexical plugin with complex state management
/**
