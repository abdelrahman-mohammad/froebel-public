    ...
    return (
        <DraggableBlockPlugin_EXPERIMENTAL
            ...
            menuComponent={
                <div
                    ref={menuRef}
                    className="draggable-block-menu absolute top-0 left-0 cursor-grab rounded-sm px-[1px] py-0.5 opacity-0 will-change-transform hover:bg-muted active:cursor-grabbing"
                >
