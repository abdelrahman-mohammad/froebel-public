...
function FloatingTextFormat({
    ...
    return (
        <div
            ...
            className="bg-sidebar border-sidebar-border absolute top-0 left-0 flex gap-1 rounded-xl border p-1.5 opacity-0 shadow-lg transition-opacity duration-300 will-change-transform"
        >
            {editor.isEditable() && (
                <>
                    <ToggleGroup
