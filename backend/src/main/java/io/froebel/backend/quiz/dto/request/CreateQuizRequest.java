...
public record CreateQuizRequest(
    ...
    public CreateQuizRequest {
        ...
        if (shuffleChoices == null) shuffleChoices = false;
        if (showCorrectAnswers == null) showCorrectAnswers = true;
        if (aiGradingEnabled == null) aiGradingEnabled = false;
        if (requireAccessCode == null) requireAccessCode = false;
        if (filterIpAddresses == null) filterIpAddresses = false;
    }
}
